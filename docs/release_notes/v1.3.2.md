...
- A full private 24/24 real-data order matrix remains deferred; the published
...
- [GitHub Release v1.3.2](https://github.com/tsubotti63/garmin-running-data-normalizer/releases/tag/v1.3.2)
- [Production PyPI 1.3.2](https://pypi.org/project/garmin-running-data-normalizer/1.3.2/)
